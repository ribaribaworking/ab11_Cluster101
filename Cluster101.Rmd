...
10. Now, let's try to remove the file: `rm file.txt`\
    \
...
-   Managing environment - the code will install the necessary libraries and make a snapshot of them. It will be stored in `renv.lock` file and can be restored later. [Here](https://rstudio.github.io/renv/articles/renv.html) is a good short tutorial on renv. You can simply supply your code with this .lock file and other users will manage easily to restore the exact environment that you used.
